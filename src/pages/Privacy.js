...
function Privacy() {
  return (
    <Page no={1} page="about" title="Privacy Policy">
      <div className="px-16 font-mont h-full pb-2 overflow-auto flex flex-col gap-2">
        ...
        <p>
          ...
          <a
            href="https://www.termsfeed.com/live/a7654176-67b6-4b41-a173-f9dd78f28d39"
            target="_blank"
          >
        ...
        <h3 className="text-base -mb-2 font-semibold">Interpretation</h3>
        <p>
        ...
        <h3 className="text-base -mb-2 font-semibold">Definitions</h3>
        ...
        <ul className="list-disc pl-8">
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Indian Institute
              of Technology Gandhinagar, Indian Institute of Technology, Palaj,
              Gujarat 382355.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to CoLab 2024, accessible from{" "}
              <a
                href="https://events.iitgn.ac.in/2023/ioh/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://events.iitgn.ac.in/2023/ioh/
              </a>
            </p>
          </li>
          <li>
        ...
        <h4 className="text-base -mb-2 font-semibold">Personal Data</h4>
        <p>
        ...
        <h4 className="text-base -mb-2 font-semibold">Usage Data</h4>
        ...
        <h4 className="text-base -mb-2 font-semibold">Business Transactions</h4>
        <p>
        ...
        <h4 className="text-base -mb-2 font-semibold">Law enforcement</h4>
        <p>
        ...
        <h2 className="text-base -mb-2 font-semibold">Children's Privacy</h2>
        <p>
        ...
        <h2 className="text-base -mb-2 font-semibold">Contact Us</h2>
        <p>
        ...
        <ul className="list-disc pl-8">
          <li>
            <p>By email: industryconnect@iitgn.ac.in</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://events.iitgn.ac.in/2023/ioh/#/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://events.iitgn.ac.in/2023/ioh/#/contact
              </a>
            </p>
          </li>
          <li>
            <p>By phone number: +91 7923952136</p>
          </li>
        </ul>
      </div>
    </Page>
